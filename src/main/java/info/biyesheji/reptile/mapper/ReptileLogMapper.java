...
public interface ReptileLogMapper {
    ...
    String fields = " trl.id id, trl.url url, trl.language_type languageType, trl.start_num startNum, trl.remark remark, trl.type type, trl.status status, trl.project_name projectName, trl.git_url gitUrl, trl.create_time createTime, trl.update_time updateTime ";
